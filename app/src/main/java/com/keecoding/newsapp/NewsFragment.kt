...
import com.keecoding.newsapp.databinding.FragmentNewsBinding
...
class NewsFragment : Fragment() {
    ...
    private fun viewNewsList() {
        ...
        viewModel.newsHeadLines.observe(viewLifecycleOwner) { response ->
            when (response) {
                is com.keecoding.newsapp.data.util.Resource.Success -> {
                ...
                is com.keecoding.newsapp.data.util.Resource.Error -> {
                    hideProgressBar()
                ...
                is com.keecoding.newsapp.data.util.Resource.Loading -> {
                    showProgressBar()
                }
